      ...
      <div className="absolute -left-4 md:-left-20 top-3">
        ...
        >
          <motion.div
            transition={{ duration: 0.2, delay: 0.5 }}
            animate={{
              backgroundColor: scrollYProgress.get() > 0 ? 'white' : 'rgb(124 58 237)',
              borderColor: scrollYProgress.get() > 0 ? 'white' : 'rgb(109 40 217)',
            }}
        ...
        <svg viewBox={`0 0 20 ${svgHeight}`} width="20" height={svgHeight} className="ml-4 block" aria-hidden="true">
          <motion.path
            ...
            fill="none" stroke="#9091A0" strokeOpacity="0.16" transition={{ duration: 10 }}
          />
          <motion.path
            d={`M 1 0V -36 l 18 24 V ${svgHeight * 0.8} l -18 24V ${svgHeight}`}
