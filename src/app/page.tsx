...
import { Zap, FileText, Brain, ArrowRight, Upload, CheckSquare, Sparkles } from 'lucide-react'
  ...
  return (
    <div style={{ background: 'var(--background)', minHeight: '100vh' }}>
      ...
      <section className="relative pt-36 pb-28 px-6 text-center overflow-hidden">
        {/* OnePrep-style radial glow behind hero */}
        <div
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <h1
            className="text-5xl font-extrabold tracking-tighter mb-5 leading-tight"
          ...
          >
            Drop a PDF, paste your notes, or enter any topic — PEAK AI instantly builds you
            structured notes and quizzes so you can focus on actually learning.
          </p>
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <Link
              href="/sign-up"
              className="inline-flex items-center gap-2 px-7 py-3 rounded-btn font-semibold text-white transition-all hover:opacity-90 hover:-translate-y-0.5 shadow-lg"
              style={{ background: 'var(--accent)', boxShadow: '0 0 28px rgba(124,58,237,0.35)' }}
            >
              Start for free <ArrowRight size={16} />
            </Link>
            <Link
              href="/sign-in"
              className="inline-flex items-center gap-2 px-7 py-3 rounded-btn font-medium border transition-all hover:opacity-70"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div
                key={f.title}
                className="relative p-6 rounded-card border transition-all hover:-translate-y-1 overflow-hidden"
                style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}
              >
                <BorderBeam size={120} duration={12} />
                <div
                  className="mb-4 w-10 h-10 rounded-btn flex items-center justify-center"
      ...
      <section className="pb-28 px-6">
        <div
          className="relative max-w-2xl mx-auto text-center p-10 rounded-card border overflow-hidden"
          style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}
        >
          <div
            className="pointer-events-none absolute inset-0 -z-10"
          ...
          />
          <BorderBeam size={200} duration={18} />
          ...
          <p className="mb-6" style={{ color: 'var(--text-muted)' }}>
            Join students already using PEAK to study faster and retain more.
          </p>
          <Link
            href="/sign-up"
            className="inline-flex items-center gap-2 px-7 py-3 rounded-btn font-semibold text-white transition-all hover:opacity-90"
            style={{ background: 'var(--accent)', boxShadow: '0 0 24px rgba(124,58,237,0.3)' }}
          >
